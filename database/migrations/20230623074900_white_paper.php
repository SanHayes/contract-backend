...
class WhitePaper extends Migrator
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table = $this->table('white_paper', $options);
        $table
            ...
            ->addColumn(Column::string('icon')->setComment('图片'))
            ->addColumn(Column::string('file')->setComment('文件链接'))
